...
func (*Scores) Descriptor() ([]byte, []int) {
	return fileDescriptor_63bfe1b824db1384, []int{0}
}
...
func init() {
	proto.RegisterType((*Scores)(nil), "singhp1069.spunky.spunky.Scores")
}

func init() { proto.RegisterFile("spunky/scores.proto", fileDescriptor_63bfe1b824db1384) }

var fileDescriptor_63bfe1b824db1384 = []byte{
	// 179 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2e, 0x2e, 0x28, 0xcd,
	0xcb, 0xae, 0xd4, 0x2f, 0x4e, 0xce, 0x2f, 0x4a, 0x2d, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17,
	0x92, 0x28, 0xce, 0xcc, 0x4b, 0xcf, 0x28, 0x30, 0x34, 0x30, 0xb3, 0xd4, 0x83, 0xc8, 0x43, 0x29,
	0xa5, 0x00, 0x2e, 0xb6, 0x60, 0xb0, 0x4a, 0x21, 0x3e, 0x2e, 0xa6, 0xcc, 0x14, 0x09, 0x46, 0x05,
	0x46, 0x0d, 0x96, 0x20, 0xa6, 0xcc, 0x14, 0x21, 0x19, 0x2e, 0xce, 0x8c, 0xcc, 0xf4, 0x0c, 0xb0,
	0x39, 0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x08, 0x01, 0x21, 0x09, 0x2e, 0xf6, 0xe4, 0xa2,
	0xd4, 0xc4, 0x92, 0xfc, 0x22, 0x09, 0x66, 0xb0, 0x1c, 0x8c, 0xeb, 0xe4, 0x7a, 0xe2, 0x91, 0x1c,
	...
	0xf9, 0xb9, 0xfa, 0x08, 0x07, 0xe9, 0x43, 0x1d, 0x5c, 0x01, 0x63, 0x94, 0x54, 0x16, 0xa4, 0x16,
	0x27, 0xb1, 0x81, 0x5d, 0x6e, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x55, 0xa5, 0x43, 0x4b, 0xd0,
	0x00, 0x00, 0x00,
}
...
func encodeVarintScores(dAtA []byte, offset int, v uint64) int {
	offset -= sovScores(v)
	base := offset
	for v >= 1<<7 {
...
func sovScores(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozScores(x uint64) (n int) {
	return sovScores(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Scores) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipScores(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipScores(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthScores
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupScores
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupScores = fmt.Errorf("proto: unexpected end of group")
)
