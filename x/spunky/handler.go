...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		case *types.MsgTransferNFT:
			...
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgCreateRewards:
			res, err := msgServer.CreateRewards(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)

		case *types.MsgDeleteRewards:
			res, err := msgServer.DeleteRewards(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
